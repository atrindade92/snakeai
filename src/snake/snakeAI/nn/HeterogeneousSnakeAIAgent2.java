...
public class HeterogeneousSnakeAIAgent2 extends SnakeAIAgent{

    private int opponentIndex;

    public HeterogeneousSnakeAIAgent2(Cell cell, int inputLayerSize, int hiddenLayerSize, int outputLayerSize, int agentIndex) {
